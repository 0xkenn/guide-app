  ...
  Future<void> _takePicture() async {
    ...
    try {
      ...
      for (String modelName in [
        ...
        double accuracy = (output != null && output.isNotEmpty)
            ? output[0]['confidence']
            : 0.0;
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          Disease selectedDisease = diseaseList
              .firstWhere((d) => d.name.toLowerCase() == selectedModel);

          return AlertDialog(
            title: const Text('Prediction Result'),
            content: Text(
                'The captured image is predicted by the model $selectedModel with $maxAccuracy% accuracy.'),
            actions: [
              TextButton(
                onPressed: () {
